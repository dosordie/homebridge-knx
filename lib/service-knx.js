...
class ServiceKNX {
	...
	loadServiceData (platformAccessory) {
		...
		// try to find it.
		/** @type {Service} */
		if (typeof platformAccessory.getServiceById === "function") {
			this.serviceHK = platformAccessory.getServiceById(this.Services[this.config.ServiceType], this.config.subtype);
		}
		if (!this.serviceHK && typeof platformAccessory.getServiceByUUIDAndSubType === "function") {
			this.serviceHK = platformAccessory.getServiceByUUIDAndSubType(this.Services[this.config.ServiceType], this.config.subtype);
		}
